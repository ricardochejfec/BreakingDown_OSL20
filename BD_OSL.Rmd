...
theme_ric <- function(plt, plot.case) {
    ...
    # +
        # scale_color_wsj(palette = "red_green") +
...
master = mutate(master,taxable_benefits = ifelse( is.na(taxable_benefits), 0, taxable_benefits))
...
```{r sum20, echo=FALSE, fig.height=12, fig.width=20, message=FALSE, warning=FALSE}
# 2020 
...
theme_ric(p_secsum_d_20, "bar")
ggsave("p_secsum_d_20", 
       plot = theme_ric(p_secsum_d_20, "bar"),
       device = "png",
       scale=1,
       width = 20,
       path = "plots/"
...
```{r delta20, echo=FALSE, fig.height=7, fig.width=14, message=FALSE, warning=FALSE}
...
```{r jobtitles, echo=FALSE, fig.height=7, fig.width=14, message=FALSE, warning=FALSE}
...
```{r sectimesum, echo=FALSE, fig.height=14, fig.width=14, message=FALSE, warning=FALSE}
# Long Sector Summary 
...
```{r infl_setup, echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE}
...
violins <- ggplot(master_inf, aes(x=factor(year), y=salary_inf)) +
    geom_violin() + 
    geom_hline(yintercept = 100000, color="#2270b5") + 
    ggtitle("Distribution of the OSL through time in real numbers")+
    xlab("Year") +
...
```{r infl_2020, echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE}
...
```{r infl_delta_20, echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE}
...
```{r inf_jobtitles, echo=FALSE, fig.height=7, fig.width=14, message=FALSE, warning=FALSE}
...
```{r inf_timesum, echo=FALSE, fig.height=14, fig.width=14, message=FALSE, warning=FALSE}
# Long Summary 
...
```{r inf_sectimesum, echo=FALSE, fig.height=14, fig.width=14, message=FALSE, warning=FALSE}
# Long Sector Summary 
