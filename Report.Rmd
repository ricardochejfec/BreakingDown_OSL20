...
|----------------------|----------------------|----------------------|
| `r top_10_jobs[1,1]` | `r top_10_jobs[1,2]` | `r top_10_jobs[1,3]` |
| `r top_10_jobs[2,1]` | `r top_10_jobs[2,2]` | `r top_10_jobs[2,3]` |
| `r top_10_jobs[3,1]` | `r top_10_jobs[3,2]` | `r top_10_jobs[3,3]` |
| `r top_10_jobs[4,1]` | `r top_10_jobs[4,2]` | `r top_10_jobs[4,3]` |
| `r top_10_jobs[5,1]` | `r top_10_jobs[5,2]` | `r top_10_jobs[5,3]` |
...
| Crown Job Title | Change %       |     | Hospitals Job Title | Change %        |     | Schools Job Title | Change %        |
|-----------------|----------------|-----|---------------------|-----------------|-----|-------------------|-----------------|
| `r jobs[1, 2]`  | `r fchange(1)` |     | `r jobs[6, 2]`      | `r fchange(6)`  |     | `r jobs[11, 2]`   | `r fchange(11)` |
| `r jobs[2, 2]`  | `r fchange(2)` |     | `r jobs[7, 2]`      | `r fchange(7)`  |     | `r jobs[12, 2]`   | `r fchange(12)` |
| `r jobs[3, 2]`  | `r fchange(3)` |     | `r jobs[8, 2]`      | `r fchange(8)`  |     | `r jobs[13, 2]`   | `r fchange(13)` |
| `r jobs[4, 2]`  | `r fchange(4)` |     | `r jobs[9, 2]`      | `r fchange(9)`  |     | `r jobs[14, 2]`   | `r fchange(14)` |
| `r jobs[5, 2]`  | `r fchange(5)` |     | `r jobs[10, 2]`     | `r fchange(10)` |     | `r jobs[15, 2]`   | `r fchange(15)` |
