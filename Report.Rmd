...
Teachers and nurses topped the list as the most popular jobs in the Ontario Sunshine List of 2020. The best paying jobs in contrast went to BLAH, BLAH, and BLAH.
...
Using a generalized additive model (GAM) with a poisson distribution, we can project what the expected growth in the number of people earning more than \$100k would have been based solely on the observed trend. The total number was expected to be between $__$ and $__$. According to this model, the list saw an increase significantly larger than predicted.
